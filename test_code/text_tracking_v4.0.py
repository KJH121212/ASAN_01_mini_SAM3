...
def main():
    ...
    json_output_dir = "/workspace/nas203/ds_RehabilitationMedicineData/IDs/tojihoo/data/test/sam3/AI_dataset/N01/N01_Treatment/diagonal__biceps_curl_v4.0"
    prompt = "person"
    
    # ⭐ [중요] 시작할 프레임 번호 (이 프레임에서 객체를 찾고 앞뒤로 퍼짐)
    START_FRAME_IDX = 2212  # 예: 400번 프레임에서 시작
    # ▲ 경로 설정 ▲
